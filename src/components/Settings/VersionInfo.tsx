...
const updateLog = [
    ...
    },
    {
      ...
      date: "2025-01-01",
      changes: [
        "⚔ Hệ thống Combat Level sử dụng XP system giống Level System bình thường",
        "→ Công thức XP: Level 1→2 cần 1 XP, Level 2→3 cần 3 XP, Level 3→4 cần 5 XP, ... (các số lẻ)",
        "◎ Mỗi combat thắng = 1 XP combat level, không giới hạn level tối đa",
        "○ Combat Level Service với XP system: getXPForCombatLevel, addCombatExperience, getCombatLevelInfo",
        "○ UI Combat Level trong InfoMenu với thanh tiến độ màu cam và format X/Y XP (Level Z)",
        "• Tích hợp Combat Experience vào CombatService để tự động cấp 1 XP khi thắng combat",
        "○ Cập nhật Character interface với combatExperience field (XP combat level)",
        "→ Tự động khởi tạo Combat Level cho character mới trong CharacterCreationPage",
        "○ Sửa logic hiển thị Combat Level đúng theo yêu cầu: Level 1: 0/1 XP, Level 2: 0/3 XP",
    ...
    },
    {
      ...
      date: "2025-01-01",
      changes: [
        "○ Hệ thống bản đồ hoàn chỉnh với grid 15x15",
        ...
        "○ Tag đặc biệt cho hành động di chuyển",
    ...
    },
    {
      ...
      changes: [
        ...
        "○ Xóa bỏ class nhân vật không cần thiết",
    ...
    },
    {
      ...
      changes: [
        ...
        "○ Tách riêng Settings thành 3 tab: API Keys, Game Settings, Version & Info",
  ...
  return (
    ...
    >
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-2">
                  <span className="text-lg font-bold text-yellow-400">v{update.version}</span>
      ...
      <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
        <h5 className="text-sm font-semibold text-yellow-300 mb-2">Thông Tin Kỹ Thuật</h5>
